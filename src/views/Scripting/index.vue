<template>
  <div>
    <div class="header"
      ...
      <div style=" margin-right: 20px;">脚本管理-脚本编写-入口</div>
    </div>
    <!-- 页面主要内容 -->
      ...
      <el-form :inline="true"
        ...
        <el-form-item label="基础信息:">
          <el-input v-model="formInline.user"
                    placeholder="请选择基础信息"></el-input>
        </el-form-item>
        <el-form-item label="接口:">
          <el-input v-model="formInline.user"
                    placeholder="请选择接口"></el-input>
        </el-form-item>
        ...
        <el-table-column fixed="right"
          ...
          <template slot-scope="scope">
            ...
            <el-button type="text"
                       ...
                       size="small"
                       style="background-color:#fff;color:#1369c2">编辑</el-button>
            <el-button type="text"
                       size="small"
